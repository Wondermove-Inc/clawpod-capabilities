...
class RegistrySyncTests(unittest.TestCase):
    ...
    def test_linked_harness_versions_are_exact_when_declared(self) -> None:
        ...
        self.assertEqual(registry_skill["version"],"0.3.4")
        self.assertEqual(registry_skill["linkedHarness"]["version"],"0.3.4")
