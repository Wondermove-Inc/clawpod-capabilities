...
commands={
'source.fetch':({'url':'string','outputRoot':'string','snapshot':'string','timeout':'integer','maxBytes':'integer','overwrite':'boolean'},['url'],True,[('outputRoot','--output-root','output'),('snapshot','--snapshot','output')]),
'source.batch':({'inputRoot':'string','manifest':'string','outputRoot':'string','output':'string','timeout':'integer','maxBytes':'integer','overwrite':'boolean'},['inputRoot','manifest'],True,[('inputRoot','--input-root','input'),('manifest','--manifest','input'),('outputRoot','--output-root','output'),('output','--output','output')]),
'source.import':({'inputRoot':'string','capture':'string','sourceUrl':'string','mediaType':'string','outputRoot':'string','output':'string','maxBytes':'integer','overwrite':'boolean'},['inputRoot','capture'],True,[('inputRoot','--input-root','input'),('capture','--capture','input'),('outputRoot','--output-root','output'),('output','--output','output')]),
