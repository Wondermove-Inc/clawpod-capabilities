...
VERSION="0.3.5"; SCHEMA=1; MAX_FILE=64*1024*1024; MAX_PAGES=200; MAX_PIXELS=40_000_000; MAX_HTTP=2*1024*1024; MAX_IMAGE_TRANSFER=8*1024*1024; MAX_REPORT_JOBS=50; MAX_REPORT_SOURCE_BYTES=256*1024*1024
CHILDREN={}
