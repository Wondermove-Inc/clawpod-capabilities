...
def test_per_run_secretrefs_manifest_contract():
 ...
 assert manifest['version']=='0.1.5' and 'credentialEnvironment' not in manifest
 ...
 assert json.loads((root/'skills/synology-smb-storage/capability.json').read_text())['linkedHarness']['version']=='0.1.5'
