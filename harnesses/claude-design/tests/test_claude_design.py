...
def test_version():
 p,o=run('system.version'); assert p.returncode==0 and o['data']['version']=='0.3.7'
...
def test_manifest_contract():
 m=json.loads((ROOT/'harness.json').read_text()); assert m['name']=='claude-design' and m['title']=='Claude Design' and m['version']=='0.3.7'
