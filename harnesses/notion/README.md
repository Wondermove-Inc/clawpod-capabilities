...
2. Use an existing owner-only `stateRoot` and bounded relative `session`/`stateName`; traversal, symlinks, missing/public roots, and non-regular targets fail closed. State is atomic, mode 0600, revisioned, redacted, and resumable.
