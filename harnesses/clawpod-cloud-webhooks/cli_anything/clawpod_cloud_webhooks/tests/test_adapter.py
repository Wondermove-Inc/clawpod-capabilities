...
def test_real_self_contained_adapter_subprocess():
    ...
    assert data["capability"]["version"] == "0.2.2"
...
def test_per_run_secretrefs_manifest_contract():
 ...
 assert manifest['version']=='0.2.2' and 'credentialEnvironment' not in manifest
 ...
 assert json.loads((root/'skills/clawpod-cloud-webhooks/capability.json').read_text())['linkedHarness']['version']=='0.2.2'
