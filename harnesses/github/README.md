...
Version 0.2 requires a pre-authenticated system `gh` CLI. Login commands are intentionally absent until a safe agent-complete browser handoff can be proven. The Harness never reads credential/config files, authorization codes, or tokens.
