...
props={k:{'type':'string'} for k in ['host','expectedAccount','repo','source','visibility','description','homepage','state','number','runId','title','body','head','base','review','mergeMethod','tag','file','endpoint','confirm']}
...
manifest={'schemaVersion':1,'kind':'openclaw.harness.v1','name':'github','title':'GitHub','description':'Guarded typed GitHub operations through the real gh CLI with stable JSON and bounded execution.','version':'0.2.0','entrypoint':'./github.py','packageRoot':'.','execution':{'cwd':'.','timeoutMs':30000,'requiresJson':True},'whenToUse':['Operate GitHub repositories, issues, pull requests, workflow runs, releases, local repository bootstrap, or bounded API reads'],'capabilities':['gh-cli','guarded-mutations','verified-release-body-update','verified-repository-bootstrap','stable-json'],'authModel':{'type':'pre-authenticated-gh-cli','storesSecrets':False,'requiresHumanAccount':True},'commands':{}}
