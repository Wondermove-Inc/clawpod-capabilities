...
class Tests(unittest.TestCase):
 ...
 def test_inventory_count(self):self.assertEqual(len(catalog()),162)
 ...
 def test_discovery_subprocess(self):
  r=self.cli('--list-commands');o=json.loads(r.stdout);self.assertEqual(r.returncode,0);self.assertEqual(len(o['data']['commands']),162)
