...
manifest={"schemaVersion":1,"kind":"openclaw.harness.v1","name":"resend-email","title":"Resend Email","description":"Guarded Resend HTTPS transactional email with per-run Gateway memory-secret injection, protected onboarding, verified-sender enforcement, previews, and retry-safe delivery.","version":"0.1.8","entrypoint":"./resend_email.py","packageRoot":".","execution":{"cwd":".","timeoutMs":120000,"requiresJson":True},"whenToUse":["Onboard, verify, preview, or send transactional email with Resend"],"capabilities":["resend-https-api","gateway-memory-secret-injection","protected-secret-handoff","verified-sender-domain","per-recipient-bulk","stable-json-redaction"],"authModel":{"type":"bearer-token-protected-injection","storesSecrets":False,"requiresHumanAccount":True},"commands":commands}
