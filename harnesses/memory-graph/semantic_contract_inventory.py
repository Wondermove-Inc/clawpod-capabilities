...
CONTRACTS={
 ...
 "semantic-validate-proposals":("semantic_v10.validate_proposals",()),
 "semantic-review-queue":("semantic_v10.review_queue",()),
 "semantic-approve":("semantic_v10.approve",()),
 "semantic-build":("semantic_v10.build_snapshot",()),
 "semantic-migrate-v09":("semantic_v10.migrate_v09",()),
 "semantic-reconcile":("semantic_v10.reconcile",()),
 "semantic-reconcile-verify":("semantic_v10.verify_reconcile",()),
