...
''', encoding="utf-8")
    ...
    def test_skill_manifest_version_and_gateway_surface_validate(self):
        ...
        self.assertEqual(set(manifest["commands"]), {"inspect", "plan", "validate-plan", "validate-snapshot", "onboard", "cron-plan", "validate-inference-candidates", "project-inference-overlay", "ontology-validate", "review-queue", "cq-evaluate", "semantic-view", "semantic-extractor-input", "semantic-seal-extraction", "semantic-validate-proposals", "semantic-review-queue", "semantic-approve", "semantic-build", "semantic-migrate-v09", "semantic-reconcile", "semantic-reconcile-verify", "semantic-export-html", "semantic-decisions-by-person", "semantic-decision-why", "semantic-decision-impacts", "semantic-decision-evidence", "semantic-hydrate"})
