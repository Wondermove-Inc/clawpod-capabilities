...
이번 배포는 preview입니다. Apple Developer ID 서명·공증과 Windows 게시자 서명은 아직 포함하지 않습니다. Mac 업데이트 후 화면 녹화·기기 제어 권한을 다시 허용해야 할 수 있습니다. 이번 수정은 앱 화면 열기에 관한 것으로, Gateway 토큰 인증 오류를 자동으로 수정하지 않습니다.
