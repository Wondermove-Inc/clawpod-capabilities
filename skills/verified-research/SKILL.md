...
Use available OpenClaw `web_fetch`, `browser`, and user-provided URLs to discover sources. The linked `verified-research` Harness (version 0.1.2) captures and validates evidence; it does **not** decide whether claims are true.
